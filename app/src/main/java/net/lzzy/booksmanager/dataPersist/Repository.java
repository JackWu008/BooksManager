...
public class Repository<T extends SQLiteTable> {
    ...
    public int getColCount(String tableName, String category) {
        Cursor cursor=dbTools.getCursor(tableName,null,DbConstants.BOOK_CATEGORY+"='"+category+"'",null,null,null,null,null);
